      ...
      <section className="bg-background max-w-[1400px] mx-auto px-5 lg:px-8 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          <div>
            ...
            <button className="w-full lg:w-auto bg-destructive/10 text-foreground border border-destructive/30 px-4 py-3 font-heading font-bold text-xs tracking-wider uppercase cursor-pointer flex items-center justify-between">
          ...
          <div className="flex flex-col items-center">
            ...
            <button className="mt-6 bg-background text-foreground border-2 border-foreground px-8 py-3 font-heading font-extrabold text-sm tracking-wider uppercase cursor-pointer">
              BEGIN
            </button>
          </div>
        </div>
      ...
      <section className="bg-card border-t border-border">
        <div className="max-w-[1400px] mx-auto grid grid-cols-1 md:grid-cols-3 gap-px bg-border">
          ...
          <div className="bg-card p-6">
            ...
            />
            <button className="mt-3 bg-transparent text-foreground border border-foreground font-heading font-bold text-[10px] tracking-wider uppercase px-3 py-2 cursor-pointer">
              SAVE ENTRY →
            </button>
          </div>
          ...
          <div className="bg-card p-6">
            ...
            {THERAPISTS.map((t) => (
              <div key={t.name} className="therapist-card mb-2 last:mb-0">
                ...
                <button className="bg-transparent text-foreground border border-foreground font-heading font-bold text-[10px] tracking-wider uppercase px-3 py-1.5 cursor-pointer shrink-0">
                  Book
                </button>
              </div>
            ))}
