    ...
    <>
      <div className={`bg-card p-5 ${isFullDashboard ? "min-h-full" : ""}`}>
        ...
        <div className="border border-primary/20 p-3 mb-4">
          ...
          <p className="text-[10px] text-muted-foreground mb-2">{featuredWorkoutMeta}</p>
        ...
        {MEALS.slice(0, 3).map((meal) => (
          <div key={meal.day} className="flex justify-between py-2 border-b border-primary/20 last:border-b-0 text-[11px]">
